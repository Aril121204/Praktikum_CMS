...
<head>
    ...
    <title>Admin Login - {{ config('app.name', 'ASIAPHONE') }}</title>
            ...
            <div class="glass-panel rounded-3xl p-8 md:p-10">
                ...
                <form method="POST" action="{{ route('admin.login') }}" id="loginForm">
                    ...
                    <div class="text-center">
                        <a href="{{ url('/') }}" class="text-gray-400 hover:text-primary text-sm transition-colors inline-flex items-center gap-2">
