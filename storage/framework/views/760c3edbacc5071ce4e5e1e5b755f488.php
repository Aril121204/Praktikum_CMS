...
<header class="fixed top-6 left-1/2 -translate-x-1/2 w-[calc(100%-48px)] max-w-container-max-width rounded-full bg-surface-container/20 backdrop-blur-[40px] border border-white/10 shadow-2xl flex justify-between items-center px-gutter py-4 z-50 transition-all duration-500">
    ...
    <div class="font-h3 text-h3 tracking-tighter text-on-surface flex items-center gap-2">
        <img
            src="<?php echo e(isset($setting) && $setting->logo ? asset('storage/' . $setting->logo) : asset('logo/asiaphone.png')); ?>"
            alt="<?php echo e(isset($setting) && $setting->logo_text ? $setting->logo_text : 'ASIAPHONE'); ?>"
            class="w-12 h-12 object-contain">
        <?php echo e(isset($setting) && $setting->logo_text ? $setting->logo_text : 'ASIAPHONE'); ?>

    </div>
    
    <!-- Navigation Menu -->
    <nav class="hidden md:flex items-center gap-10">
        <a class="<?php echo e(request()->routeIs('home') ? 'font-body-md text-body-md text-primary font-bold transition-all hover:opacity-80': 'font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300'); ?>" href="<?php echo e(route('home')); ?>">Beranda</a>
        <a class="<?php echo e(request()->routeIs('catalog*') ? 'font-body-md text-body-md text-primary font-bold transition-all hover:opacity-80': 'font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300'); ?>" href="<?php echo e(route('catalog.index')); ?>">Katalog</a>
        <a class="<?php echo e(request()->routeIs('contact*') ? 'font-body-md text-body-md text-primary font-bold transition-all hover:opacity-80': 'font-body-md text-body-md text-on-surface-variant hover:text-primary transition-all duration-300'); ?>" href="<?php echo e(route('contact')); ?>">Kontak</a>
    </nav>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const brands = <?php echo json_encode(
...
</style><?php /**PATH C:\xampp\htdocs\Praktikum_CMS\resources\views/partials/navbar.blade.php ENDPATH**/ ?>