...
<?php $__env->startSection('title', 'Hubungi Kami - AsiaPhone'); ?>
...
<main class="max-w-[1280px] mx-auto px-margin-desktop pt-44 pb-32">
    ...
    <div class="max-w-3xl mx-auto mb-8 alert-success glass-panel p-6 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 flex items-start gap-4">
        ...
        <div class="flex-1">
            ...
            <p class="text-emerald-200 text-sm"><?php echo e(session('success')); ?></p>
        </div>
    ...
    <div class="max-w-3xl mx-auto mb-8 alert-success glass-panel p-6 rounded-2xl border border-rose-500/30 bg-rose-500/10 flex items-start gap-4">
        ...
        <div class="flex-1">
            ...
            <p class="text-rose-200 text-sm"><?php echo e(session('error')); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
        ...
        <section class="glass-panel p-8 md:p-12 rounded-3xl transition-all duration-700 ease-out scroll-reveal">
            ...
            <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="flex flex-col gap-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="group">
                    ...
                    <input
                        ...
                        class="input-field w-full bg-transparent border-0 border-b border-outline-variant py-3 px-0 text-on-surface placeholder:text-surface-variant focus:ring-0 focus:border-primary transition-all duration-400 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="group">
                    ...
                    <input
                        ...
                        class="input-field w-full bg-transparent border-0 border-b border-outline-variant py-3 px-0 text-on-surface placeholder:text-surface-variant focus:ring-0 focus:border-primary transition-all duration-400 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="group">
                    ...
                    <input
                        ...
                        class="input-field w-full bg-transparent border-0 border-b border-outline-variant py-3 px-0 text-on-surface placeholder:text-surface-variant focus:ring-0 focus:border-primary transition-all duration-400 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="group">
                    ...
                    <input
                        ...
                        class="input-field w-full bg-transparent border-0 border-b border-outline-variant py-3 px-0 text-on-surface placeholder:text-surface-variant focus:ring-0 focus:border-primary transition-all duration-400 <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="group">
                    ...
                    <textarea
                        name="message"
                        class="input-field w-full bg-transparent border-0 border-b border-outline-variant py-3 px-0 text-on-surface placeholder:text-surface-variant focus:ring-0 focus:border-primary transition-all duration-400 resize-none <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-500 <?php unset($message);
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Praktikum_CMS\resources\views/frontend/contact.blade.php ENDPATH**/ ?>