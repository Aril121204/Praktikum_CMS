            ...
            <div class="flex items-center gap-8">
                ...
                <div>
                    <h2 class="font-orbitron text-4xl font-bold text-white mb-3 neon-text tracking-wider">
                        SELAMAT DATANG, <?php echo e(strtoupper(auth()->user()->name ?? 'ADMIN')); ?>! 👋
                    </h2>
            ...
            <div class="hidden lg:block">
                <div class="flex items-center gap-4 px-8 py-4 glass rounded-2xl border border-cyan-500/30">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white font-orbitron"><?php echo e(number_format(rand(1000, 5000))); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="px-4 py-2 bg-emerald-500/20 text-emerald-400 text-xs font-bold rounded-full border border-emerald-500/30 font-rajdhani tracking-wider">
                        <?php echo e($activeProducts ?? 0); ?> AKTIF
                    </span>
                </div>
                <h3 class="font-orbitron text-5xl font-bold text-white mb-2 neon-text"><?php echo e($totalProducts ?? 0); ?></h3>
                ...
                <div class="pt-6 border-t border-cyan-500/20">
                    <p class="text-xs text-gray-400 font-rajdhani tracking-wide">
                        ...
                        <?php echo e($inactiveProducts ?? 0); ?> tidak aktif
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card glass rounded-3xl p-8 relative overflow-hidden gradient-card-4 neon-border">
            <div class="relative z-10">
                ...
                <h3 class="font-orbitron text-5xl font-bold text-white mb-2 neon-text-purple"><?php echo e($totalCategories ?? 0); ?></h3>
                ...
                <div class="pt-6 border-t border-purple-500/20">
                    <p class="text-xs text-gray-400 font-rajdhani tracking-wide">
                        ...
                        <?php echo e($activeCategories ?? 0); ?> brand aktif
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card glass rounded-3xl p-8 relative overflow-hidden gradient-card-2 neon-border">
            <div class="relative z-10">
                ...
                <h3 class="font-orbitron text-5xl font-bold text-white mb-2" style="text-shadow: 0 0 20px rgba(255, 0, 110, 0.8);"><?php echo e($totalContacts ?? 0); ?></h3>
        ...
        <div class="stat-card glass rounded-3xl p-8 relative overflow-hidden gradient-card-3 neon-border">
            <div class="relative z-10">
                ...
                <h3 class="font-orbitron text-2xl font-bold text-white mb-2 neon-text">Rp <?php echo e(number_format($inventoryValue ?? 0, 0, ',', '.')); ?></h3>
                ...
                <div class="pt-6 border-t border-cyan-500/20">
                    <p class="text-xs text-gray-400 font-rajdhani tracking-wide">
                        ...
                        Avg: Rp <?php echo e(number_format($averagePrice ?? 0, 0, ',', '.')); ?>
            ...
            <div class="space-y-4 max-h-[320px] overflow-y-auto pr-2">
                ...
                <div class="group flex items-center gap-5 p-5 glass rounded-2xl hover:bg-rose-500/10 transition-all border border-white/5 hover:border-rose-500/40 neon-border">
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="text-sm font-bold text-white font-rajdhani tracking-wide truncate"><?php echo e($product->name ?? $product->NAME ?? '-'); ?></h4>
                        <p class="text-xs text-cyan-400/60 font-rajdhani"><?php echo e($product->category->name ?? '-'); ?></p>
                    </div>
                    <div class="text-right">
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-xs font-bold bg-rose-500/20 text-rose-400 border border-rose-500/30 font-rajdhani tracking-wider">
                            <?php echo e($product->stock ?? $product->STOCK ?? 0); ?> UNIT
                        </span>
                    </div>
                </div>
                    ...
                    <tr class="group hover:bg-cyan-500/5 transition-all">
                        <td class="py-5 px-6">
                            <div class="flex items-center gap-5">
                                ...
                                <div class="min-w-0">
                                    <h4 class="text-sm font-bold text-white font-rajdhani tracking-wide truncate"><?php echo e($product->name ?? $product->NAME ?? '-'); ?></h4>
                                    <p class="text-xs text-cyan-400/60 font-rajdhani"><?php echo e($product->model ?? $product->MODEL ?? '-'); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="py-5 px-6">
                        ...
                        <td class="py-5 px-6 text-right">
                            <span class="text-sm font-bold text-white font-orbitron tracking-wide">
                                Rp <?php echo e(number_format($product->price ?? $product->PRICE ?? 0, 0, ',', '.')); ?>
                        ...
                        <td class="py-5 px-6 text-center">
                            ...
                            ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-xs font-bold <?php echo e($stock > 0 ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-rose-500/20 text-rose-400 border border-rose-500/30'); ?> font-rajdhani tracking-wider">
                                <?php echo e($stock); ?>
                ...
                <div class="flex items-start gap-5">
                    <div class="w-14 h-14 rounded-full bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform shadow-xl shadow-cyan-500/30">
                        <span class="text-white font-bold text-xl font-orbitron">
                            <?php echo e(substr($contact->name ?? $contact->NAME ?? '?', 0, 1)); ?>

                        </span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between mb-3">
                            <h4 class="text-sm font-bold text-white font-rajdhani tracking-wide"><?php echo e($contact->name ?? $contact->NAME ?? '-'); ?></h4>
                            <span class="text-xs text-cyan-400/60 font-rajdhani"><?php echo e($contact->created_at ?? $contact->CREATED_AT ?? ''); ?></span>
                        </div>
                        <p class="text-xs text-cyan-400 mb-3 font-bold font-rajdhani tracking-wide"><?php echo e($contact->subject ?? $contact->SUBJECT ?? '-'); ?></p>
                        <p class="text-sm text-gray-400 line-clamp-2 font-rajdhani"><?php echo e(Str::limit($contact->message ?? $contact->MESSAGE ?? '', 100)); ?></p>
                    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (ctx) {
            const categoryData = <?php echo json_encode($productsByCategory ?? [], 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Praktikum_CMS\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>