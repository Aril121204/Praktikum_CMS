            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4">
                ...
                <div class="mb-6">
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                ...
                <div class="mb-6">
                    ...
                    <a href="<?php echo e(route('admin.categories.index')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('admin.products.index')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('admin.contacts.index')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.contacts.*') ? 'active' : ''); ?>">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('admin.settings.profile')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.settings.profile') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('admin.settings.site')); ?>"
                       class="sidebar-link flex items-center gap-4 px-4 py-3.5 text-slate-300 rounded-xl mb-2 font-medium <?php echo e(request()->routeIs('admin.settings.site') ? 'active' : ''); ?>">
            ...
            <div class="border-t border-slate-700/30 p-4 bg-gradient-to-t from-slate-900/50 to-transparent">
                ...
                <div class="flex items-center gap-3 mb-4 px-2">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-white font-space truncate"><?php echo e(auth()->user()->name ?? 'Admin'); ?></p>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="top-bar h-20 flex items-center justify-between px-8">
                <div class="flex items-center gap-4">
                    ...
                    <h2 class="font-space font-bold text-xl text-white"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h2>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="hidden lg:flex items-center gap-2 px-4 py-2 bg-slate-800/50 rounded-xl border border-slate-700/30">
                        ...
                        <span class="text-sm text-slate-300 font-medium"><?php echo e(now()->format('d M Y')); ?></span>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto p-8">
                ...
                <div class="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl flex items-center gap-3 animate-fade-in">
                    ...
                    <p class="text-emerald-400 font-medium"><?php echo e(session('success')); ?></p>
                </div>
                <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum_CMS\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>