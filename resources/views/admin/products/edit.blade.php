...
<div class="max-w-6xl mx-auto animate-fade-in">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-400">Update informasi produk "{{ $product->name }}"</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="condition" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:border-blue-500/50 transition-all font-space" required>
                        ...
                        <option value="used" {{ old('condition', $product->condition) == 'used' ? 'selected' : '' }}>Bekas (Used)</option>
                    </select>
                    @error('condition')
                        <p class="text-rose-400 text-xs mt-2">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="brand" id="productBrand" value="{{ old('brand', $product->brand) }}" placeholder="Contoh: Samsung" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-all font-space" required>
                    @error('brand')
                        <p class="text-rose-400 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="model" value="{{ old('model', $product->model) }}" placeholder="Contoh: Snapdragon 8 Elite" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-all font-space">
                    @error('model')
                        <p class="text-rose-400 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="modern-card p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price', $product->price) }}" placeholder="21999000" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space" required>
                    @error('price')
                        <p class="text-rose-400 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="discount_price" value="{{ old('discount_price', $product->discount_price) }}" placeholder="19999000" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space">
                ...
                <div>
                    ...
                    <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" placeholder="15" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space" required>
                    @error('stock')
                        <p class="text-rose-400 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[processor]" value="{{ old('spec.processor', $product->spec->processor ?? '') }}" placeholder="Snapdragon 8 Elite" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">RAM</label>
                            <input type="text" name="spec[ram]" value="{{ old('spec.ram', $product->spec->ram ?? '') }}" placeholder="12GB" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Penyimpanan</label>
                            <input type="text" name="spec[storage]" value="{{ old('spec.storage', $product->spec->storage ?? '') }}" placeholder="512GB" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            ...
                            <select name="spec[expandable_storage]" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:border-purple-500/50 transition-all font-space">
                                <option value="N" {{ old('spec.expandable_storage', $product->spec->expandable_storage ?? 'N') == 'N' ? 'selected' : '' }}>Tidak Ada</option>
                                <option value="Y" {{ old('spec.expandable_storage', $product->spec->expandable_storage ?? 'N') == 'Y' ? 'selected' : '' }}>Ada (MicroSD)</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[display]" value="{{ old('spec.display', $product->spec->display ?? '') }}" placeholder="6.8-inch AMOLED 144Hz" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Resolusi</label>
                            <input type="text" name="spec[resolution]" value="{{ old('spec.resolution', $product->spec->resolution ?? '') }}" placeholder="2436 x 1080 pixels" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[camera_rear]" value="{{ old('spec.camera_rear', $product->spec->camera_rear ?? '') }}" placeholder="108MP OIS + 50MP Ultra Wide" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Kamera Depan</label>
                            <input type="text" name="spec[camera_front]" value="{{ old('spec.camera_front', $product->spec->camera_front ?? '') }}" placeholder="50MP" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[battery]" value="{{ old('spec.battery', $product->spec->battery ?? '') }}" placeholder="5000mAh" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Fast Charging</label>
                            <input type="text" name="spec[charging]" value="{{ old('spec.charging', $product->spec->charging ?? '') }}" placeholder="45W Fast Charging" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[os]" value="{{ old('spec.os', $product->spec->os ?? '') }}" placeholder="Android 14" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Konektivitas</label>
                            <input type="text" name="spec[connectivity]" value="{{ old('spec.connectivity', $product->spec->connectivity ?? '') }}" placeholder="5G, WiFi 6E, Bluetooth 5.3" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[dimensions]" value="{{ old('spec.dimensions', $product->spec->dimensions ?? '') }}" placeholder="164.3 x 74.6 x 7.9 mm" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Warna</label>
                            <input type="text" name="spec[colors]" value="{{ old('spec.colors', $product->spec->colors ?? '') }}" placeholder="Rock Black, Violet Garden" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
        ...
        <div class="modern-card p-8">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Deskripsi lengkap produk..." class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all font-space resize-none">{{ old('description', $product->description) }}</textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-2">Filosofi Produk</label>
                    <textarea name="philosophy" rows="3" placeholder="Filosofi atau nilai unik..." class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all font-space resize-none">{{ old('philosophy', $product->philosophy) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ asset('product/' . strtolower($product->brand) . '/' . $product->image) }}" alt="{{ $product->name }}" class="w-full h-48 object-contain rounded-xl bg-slate-900/50 p-4">
                    </div>
                    @endif
                    @error('image')
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="is_active" value="Y" {{ old('is_active', $product->is_active) === 'Y' ? 'checked' : '' }} class="peer sr-only">
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="is_active" value="N" {{ old('is_active', $product->is_active) === 'N' ? 'checked' : '' }} class="peer sr-only">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_featured" value="Y" {{ old('is_featured', $product->is_featured) === 'Y' ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_hot_deal" value="Y" {{ old('is_hot_deal', $product->is_hot_deal) === 'Y' ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_gaming" value="Y" {{ old('is_gaming', $product->is_gaming) === 'Y' ? 'checked' : '' }} class="peer sr-only">
