...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="condition" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:border-blue-500/50 transition-all font-space" required>
                        <option value="new" <?php echo e(old('condition') == 'new' ? 'selected' : ''); ?>>Baru (New)</option>
                        <option value="used" <?php echo e(old('condition') == 'used' ? 'selected' : ''); ?>>Bekas (Used)</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" id="productName" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Samsung Galaxy S25 Ultra" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-all font-space" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="brand" id="productBrand" value="<?php echo e(old('brand')); ?>" placeholder="Contoh: Samsung" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-all font-space" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="model" value="<?php echo e(old('model')); ?>" placeholder="Contoh: Snapdragon 8 Elite" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-all font-space">
        ...
        <div class="modern-card p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price')); ?>" placeholder="21999000" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="discount_price" value="<?php echo e(old('discount_price')); ?>" placeholder="19999000" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="discount_percent" value="<?php echo e(old('discount_percent', 0)); ?>" placeholder="8" min="0" max="100" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="stock" value="<?php echo e(old('stock', 0)); ?>" placeholder="15" min="0" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-all font-space" required>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[processor]" value="<?php echo e(old('spec.processor')); ?>" placeholder="Snapdragon 8 Elite" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">RAM</label>
                            <input type="text" name="spec[ram]" value="<?php echo e(old('spec.ram')); ?>" placeholder="12GB" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Penyimpanan</label>
                            <input type="text" name="spec[storage]" value="<?php echo e(old('spec.storage')); ?>" placeholder="512GB" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            ...
                            <select name="spec[expandable_storage]" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:border-purple-500/50 transition-all font-space">
                                <option value="N" <?php echo e(old('spec.expandable_storage', 'N') == 'N' ? 'selected' : ''); ?>>Tidak Ada</option>
                                <option value="Y" <?php echo e(old('spec.expandable_storage') == 'Y' ? 'selected' : ''); ?>>Ada (MicroSD)</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[display]" value="<?php echo e(old('spec.display')); ?>" placeholder="6.8-inch AMOLED 144Hz" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Resolusi</label>
                            <input type="text" name="spec[resolution]" value="<?php echo e(old('spec.resolution')); ?>" placeholder="2436 x 1080 pixels" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[camera_rear]" value="<?php echo e(old('spec.camera_rear')); ?>" placeholder="108MP OIS + 50MP Ultra Wide" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Kamera Depan</label>
                            <input type="text" name="spec[camera_front]" value="<?php echo e(old('spec.camera_front')); ?>" placeholder="50MP" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[battery]" value="<?php echo e(old('spec.battery')); ?>" placeholder="5000mAh" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Fast Charging</label>
                            <input type="text" name="spec[charging]" value="<?php echo e(old('spec.charging')); ?>" placeholder="45W Fast Charging" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[os]" value="<?php echo e(old('spec.os')); ?>" placeholder="Android 14" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Konektivitas</label>
                            <input type="text" name="spec[connectivity]" value="<?php echo e(old('spec.connectivity')); ?>" placeholder="5G, WiFi 6E, Bluetooth 5.3" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spec[dimensions]" value="<?php echo e(old('spec.dimensions')); ?>" placeholder="164.3 x 74.6 x 7.9 mm" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-300 mb-2">Warna</label>
                            <input type="text" name="spec[colors]" value="<?php echo e(old('spec.colors')); ?>" placeholder="Rock Black, Violet Garden" class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 transition-all font-space">
                        </div>
                    </div>
                </div>
        ...
        <div class="modern-card p-8">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="description" rows="4" placeholder="Deskripsi lengkap produk..." class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all font-space resize-none"><?php echo e(old('description')); ?></textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-2">Filosofi Produk</label>
                    <textarea name="philosophy" rows="3" placeholder="Filosofi atau nilai unik..." class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-amber-500/50 transition-all font-space resize-none"><?php echo e(old('philosophy')); ?></textarea>
                </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex gap-4">
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="is_active" value="Y" <?php echo e(old('is_active', 'Y') === 'Y' ? 'checked' : ''); ?> class="peer sr-only">
                        ...
                        <label class="flex-1 cursor-pointer">
                            <input type="radio" name="is_active" value="N" <?php echo e(old('is_active') === 'N' ? 'checked' : ''); ?> class="peer sr-only">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_featured" value="Y" <?php echo e(old('is_featured') === 'Y' ? 'checked' : ''); ?> class="peer sr-only">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_hot_deal" value="Y" <?php echo e(old('is_hot_deal') === 'Y' ? 'checked' : ''); ?> class="peer sr-only">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <input type="checkbox" name="is_gaming" value="Y" <?php echo e(old('is_gaming') === 'Y' ? 'checked' : ''); ?> class="peer sr-only">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Praktikum_CMS\resources\views/admin/products/create.blade.php ENDPATH**/ ?>